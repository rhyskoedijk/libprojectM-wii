...
//	  *vol=vol_instant/(1.5*vol_history);
    ...
    switch (settings.pulseSource) {
        ...
        case PM_AC_BASS: wiiLightSetLevel(bass); break;
        case PM_AC_MIDDLE: wiiLightSetLevel(mid); break;
        case PM_AC_TREBLE: wiiLightSetLevel(treb); break;
        case PM_AC_VOLUME: wiiLightSetLevel(vol); break;
